...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/installation"
  >
    Run the entire stack on your own infrastructure via Docker Compose. The
    dashboard loads site favicons and provider logos from public CDNs, and
    incident data leaves your host only through channels you configure
    (notifications, webhooks, AI providers — pick the local Ollama profile to
    keep AI analysis fully offline).
  </Card>
</CardGroup>
