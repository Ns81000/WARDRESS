...
flowchart LR
    ...
    C1 -->|"yes"| J1["Jaccard<br/>vs reference"]:::node
    C2 -->|"yes"| J2["Jaccard<br/>vs reference"]:::node
    C1 -->|"403/429/fail"| SKIP1(["Record<br/>not scored"]):::skip
    C2 -->|"403/429/fail"| SKIP2(["Record<br/>not scored"]):::skip
    RT -.-> J1
    RT -.-> J2
    J1 & J2 --> WD(("worst<br/>divergence")):::pick
    WD --> SK["soft knee<br/>at 0.5"]:::node
    SK --> OUT["Layer 7<br/>0.0 – 1.0"]:::out
